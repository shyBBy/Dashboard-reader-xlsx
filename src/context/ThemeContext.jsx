...
const minimalDarkPalette = {
    ...
    text: {
        primary: '#f1f5f9',
        secondary: 'rgba(203, 213, 225, 0.75)',
    ...
    background: {
        paper: '#0f172a',
        default: '#020617',
        neutral: 'rgba(51, 65, 85, 0.15)',
    },
    action: {
        active: 'rgba(203, 213, 225, 0.75)',
        hover: 'rgba(100, 116, 139, 0.08)',
        selected: 'rgba(100, 116, 139, 0.16)',
        disabled: 'rgba(100, 116, 139, 0.35)',
        disabledBackground: 'rgba(51, 65, 85, 0.2)',
        focus: 'rgba(100, 116, 139, 0.2)',
        hoverOpacity: 0.08,
        selectedOpacity: 0.16,
